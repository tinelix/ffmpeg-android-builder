...
if [ ! -d "ffmpeg-2.5.11" ]; then
  echo "[ERROR] FFmpeg 2.5.11 source code not found. Please download it from https://github.com/ffmpeg/ffmpeg.";
  exit 1
fi

FFMPEG_VERSION="2.5.11"

echo "Creating output directories...";
chmod -R 0777 .
mkdir -p ffmpeg-2.5.11/android
mkdir -p ffmpeg-2.5.11/android/armeabi
mkdir -p ffmpeg-2.5.11/android/armeabi-v7a
mkdir -p ffmpeg-2.5.11/android/arm64-v8a
mkdir -p ffmpeg-2.5.11/android/x86
